                  ...
                  <table class="table table-borderless" style="font-size: 14px;">
                    ...
                    <tbody id="result_report">
                      ...
                      <tr>
                        <td>
                          <p>
                            <?=$b.".".$i." ".$view_cat1->dep_fullname?><?php if($view_cat1->dep_id == $dep_id){?>
                            <a data-toggle="modal" data-target="#modelCreateReport">
                            <i data-toggle="tooltip" data-placement="top" style="cursor: pointer;" class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400 edit" 
                            data-id="<?=$view_cat1->des_id?>"
                            data-plan_id="<?=$view_cat1->plan_id?>"    
                            data-operation="<?=$view_cat1->des_detail?>" "                        
                            data-report_start="<?=$view_cat1->des_report_start?>"
                            data-report_end="<?=$view_cat1->des_report_end?>"
                            data-note="<?=$view_cat1->des_note?>"
                            data-user_part_name="<?=$view_cat1->dep_short_name?>"
                            title="แก้ไข | <?=$dep_shortname?>"></i>
                            </a>
                            <?php }?>
                          </p>
                      ...
                      $i_cat2=2;
                      $b_cat2=2;
                      while($view_cat2=$result_plan1->fetch_object())
                      {
                        if($view_cat2->cat_id == 2){
                        ?> 
                      <tr>
                        <td>
                          <p>
                            <?=$b_cat2.".".$i_cat2." ".$view_cat2->dep_fullname?><?php if($view_cat2->dep_id == $dep_id){?>
                            <a data-toggle="modal" data-target="#modelCreateReport">
                            <i data-toggle="tooltip" data-placement="top" style="cursor: pointer;" class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400 edit" 
                            data-id="<?=$view_cat2->des_id?>"
                            data-plan_id="<?=$view_cat2->plan_id?>"    
                            data-operation="<?=$view_cat2->des_detail?>" "                        
                            data-report_start="<?=$view_cat2->des_report_start?>"
                            data-report_end="<?=$view_cat2->des_report_end?>"
                            data-note="<?=$view_cat2->des_note?>"
                            data-user_part_name="<?=$view_cat2->dep_short_name?>"
                            title="แก้ไข | <?=$dep_shortname?>"></i>
                            </a>
                            <?php }?>
                          </p>
                          <?php if($view_cat2->dep_area != ''){?>
                          <p style="padding-left:25px;">
                            <?=$view_cat2->dep_area?>
                          </p>
                          <?}?>
                          ...
                          <p style="padding-left:25px;">
                            วันเริ่มต้น : <?=formatDate($view_cat2->des_report_start)?>
                          </p>
                          <p  style="padding-left:25px;">
                            วันสิ้นสุด : <?=formatDate($view_cat2->des_report_end)?>
                          </p>
                        
                          
                        </td>
                        <td>
                          <?=$view_cat2->des_detail?>
                        </td>
                        <td>
                          <?=$view_cat2->des_note?>
                        </td>
